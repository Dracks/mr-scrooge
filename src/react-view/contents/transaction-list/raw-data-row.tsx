...
import { BankTransactionEnriched } from '../common/raw-data-source.context';

interface TransactionRowProps {
    labels: GQLLabel[];
    onChange: (newData: GQLBankTransaction) => void;
    rds: BankTransactionEnriched;
}

export const TransactionRow: React.FC<TransactionRowProps> = ({ rds, labels, onChange }) => {
