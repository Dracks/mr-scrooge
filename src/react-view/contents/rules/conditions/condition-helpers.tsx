...
export const allOperations : Array<OperationString | OperationDouble> = [...operationDouble.values(), ...operationString.values()];
...
export const allOperationsTuples = allOperations.map(operation => ({key: operation, label: operationText[operation]}))
