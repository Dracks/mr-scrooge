...
export const NewRuleForm: React.FC = ()=>{
    ...
    const [formData, setFormData] = React.useState<RuleParam>({groupOwnerId: profile.defaultGroupId, name: "", relations: "or" })
    ...
    return <Box pad="small">
        ...
        <Form<RuleParam> 
            ...
            onSubmit={()=>{
                catchAndLog(createRule.execute(formData).then(response => {
                    refresh()
