...
export const enrichRuleList = (rules: Rule[], labelsMap: Map<ApiUUID, Label>): { rules: RuleEnriched[], rulesMap: Map<ApiUUID, RuleEnriched> } => {
    const rulesEnriched : RuleEnriched[] = rules.map(({labelIds: labelIds, ...rule}: Rule) => ({
        ...rule,
        children: [],
