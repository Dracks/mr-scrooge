...
import { getMigration, parseDifference, reverseModels, sortActions,writeMigration } from './auto-migration-lib';
import { TablesMap } from './auto-migration-lib/types';
...
export class MigrationsCommand {
    ...
    constructor(
        ...
        @Inject('Umzug') private readonly umzug: Umzug,
    ) {}
    ...
    makeMigrations(
        ...
        const info = writeMigration(currentState.revision, migration, migrationsDir, name, '');
