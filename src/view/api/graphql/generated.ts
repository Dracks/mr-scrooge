...
export function useGetBankTransactionsQuery(
    options?: Omit<Urql.UseQueryArgs<GQLGetBankTransactionsQueryVariables>, 'query'>,
) {
    return Urql.useQuery<GQLGetBankTransactionsQuery, GQLGetBankTransactionsQueryVariables>({
...
export function useGetGraphsByIdQuery(options?: Omit<Urql.UseQueryArgs<GQLGetGraphsByIdQueryVariables>, 'query'>) {
    return Urql.useQuery<GQLGetGraphsByIdQuery, GQLGetGraphsByIdQueryVariables>({
        query: GetGraphsByIdDocument,
        ...options,
    });
}
...
export function useGetImportKindsQuery(options?: Omit<Urql.UseQueryArgs<GQLGetImportKindsQueryVariables>, 'query'>) {
    return Urql.useQuery<GQLGetImportKindsQuery, GQLGetImportKindsQueryVariables>({
        query: GetImportKindsDocument,
        ...options,
    });
}
...
export type GQLDeleteGraphMutation = {
    __typename?: 'Mutation';
    deleteGraph:
        | { __typename: 'Confirmation' }
        | { __typename: 'InvalidGraph'; availableGraphsId: Array<number> }
        | { __typename: 'WrongOwnerId' };
};
...
export type GQLGetGraphsByIdQuery = {
    __typename?: 'Query';
    graphs: Array<{
        __typename?: 'Graph';
        id: number;
...
export type GQLNewGraphMutation = {
    ...
    newGraph:
        ...
        | { __typename: 'InvalidLabel'; invalidLabels: Array<number> }
...
export type GQLUpdateGraphMutation = {
    __typename?: 'Mutation';
    updateGraph:
        | {
              __typename: 'Graph';
