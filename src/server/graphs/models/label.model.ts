...
export type ILabelAttributes = InferAttributes<LabelModel>

@Table({
    tableName: 'graph_label',
    timestamps: false,
})
export class LabelModel extends Model<ILabelAttributes, InferCreationAttributes<LabelModel>> {
    @Column({
        primaryKey: true,
        autoIncrement: true,
...
export class LabelTransactionModel extends Model<InferAttributes<LabelTransactionModel>, InferCreationAttributes<LabelTransactionModel>>{
