...
export class GraphGroupModel extends AbstractGroupModel<InferAttributes<GraphGroupModel>, InferCreationAttributes<GraphGroupModel>>{}
...
export class GraphHorizontalGroupModel extends AbstractGroupModel<InferAttributes<GraphHorizontalGroupModel>, InferCreationAttributes<GraphHorizontalGroupModel>>{
    @Column({
        type: DataType.BOOLEAN,
        defaultValue: false,
    })
...
export class GraphGroupTagsModel extends Model<InferAttributes<GraphGroupTagsModel>, InferCreationAttributes<GraphGroupTagsModel>>{
    @Column({
        type: DataType.INTEGER,
        primaryKey: true,
    })
...
export class GraphHorizontalGroupTagsModel extends Model<InferAttributes<GraphHorizontalGroupTagsModel>, InferCreationAttributes<GraphGroupTagsModel>>{
    @Column({
        type: DataType.INTEGER,
        primaryKey: true,
    })
