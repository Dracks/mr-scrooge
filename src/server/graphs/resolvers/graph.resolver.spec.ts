...
import {
    ...
    GetGraphsDocument,
    GQLDeleteGraphMutation,
    GQLDeleteGraphMutationVariables,
    GQLGetGraphsByIdQuery,
    GQLGetGraphsByIdQueryVariables,
    GQLGetGraphsQuery,
    ...
    GQLUpdateGraphMutation,
    GQLUpdateGraphMutationVariables,
    NewGraphDocument,
    UpdateGraphDocument,
...
describe(GraphResolver.name, () => {
    ...
    describe('UpdateGraph', () => {
        ...
        beforeEach(async () => {
            const graphsToCreate = [GraphFactory.build()];
