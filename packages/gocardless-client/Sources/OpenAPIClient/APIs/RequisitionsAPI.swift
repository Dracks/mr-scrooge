...
open class RequisitionsAPI {
     ...
     */
    open class func createRequisition(requisitionRequest: RequisitionRequest, apiConfiguration: OpenAPIClientAPIConfiguration = OpenAPIClientAPIConfiguration.shared) async throws(ErrorResponse) -> SpectacularRequisition {
     ...
     */
    open class func createRequisitionWithRequestBuilder(requisitionRequest: RequisitionRequest, apiConfiguration: OpenAPIClientAPIConfiguration = OpenAPIClientAPIConfiguration.shared) -> RequestBuilder<SpectacularRequisition> {
     ...
     */
    open class func deleteRequisitionById(id: UUID, apiConfiguration: OpenAPIClientAPIConfiguration = OpenAPIClientAPIConfiguration.shared) async throws(ErrorResponse) -> SuccessfulDeleteResponse {
     ...
     */
    open class func deleteRequisitionByIdWithRequestBuilder(id: UUID, apiConfiguration: OpenAPIClientAPIConfiguration = OpenAPIClientAPIConfiguration.shared) -> RequestBuilder<SuccessfulDeleteResponse> {
    ...
    /**
     ...
     - returns: Requisition
     */
    open class func requisitionById(id: UUID, apiConfiguration: OpenAPIClientAPIConfiguration = OpenAPIClientAPIConfiguration.shared) async throws(ErrorResponse) -> Requisition {
     ...
     */
    open class func requisitionByIdWithRequestBuilder(id: UUID, apiConfiguration: OpenAPIClientAPIConfiguration = OpenAPIClientAPIConfiguration.shared) -> RequestBuilder<Requisition> {
        var localVariablePath = "/api/v2/requisitions/{id}/"
        let idPreEscape = "\(APIHelper.mapValueToPathItem(id))"
        let idPostEscape = idPreEscape.addingPercentEncoding(withAllowedCharacters: .urlPathAllowed) ?? ""
        localVariablePath = localVariablePath.replacingOccurrences(of: "{id}", with: idPostEscape, options: .literal, range: nil)
     ...
     */
    open class func retrieveAllRequisitions(limit: Int? = nil, offset: Int? = nil, apiConfiguration: OpenAPIClientAPIConfiguration = OpenAPIClientAPIConfiguration.shared) async throws(ErrorResponse) -> PaginatedRequisitionList {
     ...
     */
    open class func retrieveAllRequisitionsWithRequestBuilder(limit: Int? = nil, offset: Int? = nil, apiConfiguration: OpenAPIClientAPIConfiguration = OpenAPIClientAPIConfiguration.shared) -> RequestBuilder<PaginatedRequisitionList> {
        let localVariablePath = "/api/v2/requisitions/"
        let localVariableURLString = apiConfiguration.basePath + localVariablePath
        let localVariableParameters: [String: any Sendable]? = nil
