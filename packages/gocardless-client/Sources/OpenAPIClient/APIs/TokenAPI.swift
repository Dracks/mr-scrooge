...
open class TokenAPI {
     ...
     */
    open class func getANewAccessToken(jWTRefreshRequest: JWTRefreshRequest, apiConfiguration: OpenAPIClientAPIConfiguration = OpenAPIClientAPIConfiguration.shared) async throws(ErrorResponse) -> SpectacularJWTRefresh {
     ...
     */
    open class func getANewAccessTokenWithRequestBuilder(jWTRefreshRequest: JWTRefreshRequest, apiConfiguration: OpenAPIClientAPIConfiguration = OpenAPIClientAPIConfiguration.shared) -> RequestBuilder<SpectacularJWTRefresh> {
     ...
     */
    open class func obtainNewAccessRefreshTokenPair(jWTObtainPairRequest: JWTObtainPairRequest, apiConfiguration: OpenAPIClientAPIConfiguration = OpenAPIClientAPIConfiguration.shared) async throws(ErrorResponse) -> SpectacularJWTObtain {
     ...
     */
    open class func obtainNewAccessRefreshTokenPairWithRequestBuilder(jWTObtainPairRequest: JWTObtainPairRequest, apiConfiguration: OpenAPIClientAPIConfiguration = OpenAPIClientAPIConfiguration.shared) -> RequestBuilder<SpectacularJWTObtain> {
