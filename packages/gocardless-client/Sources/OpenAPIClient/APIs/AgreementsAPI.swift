...
open class AgreementsAPI {
     ...
     */
    open class func acceptEUA(id: UUID, enduserAcceptanceDetailsRequest: EnduserAcceptanceDetailsRequest, apiConfiguration: OpenAPIClientAPIConfiguration = OpenAPIClientAPIConfiguration.shared) async throws(ErrorResponse) -> EndUserAgreement {
     ...
     */
    open class func acceptEUAWithRequestBuilder(id: UUID, enduserAcceptanceDetailsRequest: EnduserAcceptanceDetailsRequest, apiConfiguration: OpenAPIClientAPIConfiguration = OpenAPIClientAPIConfiguration.shared) -> RequestBuilder<EndUserAgreement> {
    ...
    /**
     ...
     - returns: EndUserAgreement
     */
    open class func createEUA(endUserAgreementRequest: EndUserAgreementRequest, apiConfiguration: OpenAPIClientAPIConfiguration = OpenAPIClientAPIConfiguration.shared) async throws(ErrorResponse) -> EndUserAgreement {
    ...
    /**
     ...
     - returns: RequestBuilder<EndUserAgreement> 
     */
    open class func createEUAWithRequestBuilder(endUserAgreementRequest: EndUserAgreementRequest, apiConfiguration: OpenAPIClientAPIConfiguration = OpenAPIClientAPIConfiguration.shared) -> RequestBuilder<EndUserAgreement> {
     ...
     */
    open class func createEUAReconfirmation(id: UUID, reconfirmationRetrieveRequest: ReconfirmationRetrieveRequest? = nil, apiConfiguration: OpenAPIClientAPIConfiguration = OpenAPIClientAPIConfiguration.shared) async throws(ErrorResponse) -> ReconfirmationRetrieve {
     ...
     */
    open class func createEUAReconfirmationWithRequestBuilder(id: UUID, reconfirmationRetrieveRequest: ReconfirmationRetrieveRequest? = nil, apiConfiguration: OpenAPIClientAPIConfiguration = OpenAPIClientAPIConfiguration.shared) -> RequestBuilder<ReconfirmationRetrieve> {
     ...
     */
    open class func deleteEUAById(id: UUID, apiConfiguration: OpenAPIClientAPIConfiguration = OpenAPIClientAPIConfiguration.shared) async throws(ErrorResponse) -> SuccessfulDeleteResponse {
     ...
     */
    open class func deleteEUAByIdWithRequestBuilder(id: UUID, apiConfiguration: OpenAPIClientAPIConfiguration = OpenAPIClientAPIConfiguration.shared) -> RequestBuilder<SuccessfulDeleteResponse> {
     ...
     */
    open class func retrieveAllAgreements(limit: Int? = nil, offset: Int? = nil, apiConfiguration: OpenAPIClientAPIConfiguration = OpenAPIClientAPIConfiguration.shared) async throws(ErrorResponse) -> PaginatedEndUserAgreementList {
     ...
     */
    open class func retrieveAllAgreementsWithRequestBuilder(limit: Int? = nil, offset: Int? = nil, apiConfiguration: OpenAPIClientAPIConfiguration = OpenAPIClientAPIConfiguration.shared) -> RequestBuilder<PaginatedEndUserAgreementList> {
        let localVariablePath = "/api/v2/agreements/enduser/"
        let localVariableURLString = apiConfiguration.basePath + localVariablePath
        let localVariableParameters: [String: any Sendable]? = nil
    ...
    /**
     ...
     - returns: EndUserAgreement
     */
    open class func retrieveEUAById(id: UUID, apiConfiguration: OpenAPIClientAPIConfiguration = OpenAPIClientAPIConfiguration.shared) async throws(ErrorResponse) -> EndUserAgreement {
    ...
    /**
     ...
     - returns: RequestBuilder<EndUserAgreement> 
     */
    open class func retrieveEUAByIdWithRequestBuilder(id: UUID, apiConfiguration: OpenAPIClientAPIConfiguration = OpenAPIClientAPIConfiguration.shared) -> RequestBuilder<EndUserAgreement> {
        var localVariablePath = "/api/v2/agreements/enduser/{id}/"
        let idPreEscape = "\(APIHelper.mapValueToPathItem(id))"
        let idPostEscape = idPreEscape.addingPercentEncoding(withAllowedCharacters: .urlPathAllowed) ?? ""
        localVariablePath = localVariablePath.replacingOccurrences(of: "{id}", with: idPostEscape, options: .literal, range: nil)
    ...
    /**
     ...
     - returns: ReconfirmationRetrieve
     */
    open class func retrieveEUAReconfirmation(id: UUID, apiConfiguration: OpenAPIClientAPIConfiguration = OpenAPIClientAPIConfiguration.shared) async throws(ErrorResponse) -> ReconfirmationRetrieve {
    ...
    /**
     ...
     - returns: RequestBuilder<ReconfirmationRetrieve> 
     */
    open class func retrieveEUAReconfirmationWithRequestBuilder(id: UUID, apiConfiguration: OpenAPIClientAPIConfiguration = OpenAPIClientAPIConfiguration.shared) -> RequestBuilder<ReconfirmationRetrieve> {
        var localVariablePath = "/api/v2/agreements/enduser/{id}/reconfirm/"
        let idPreEscape = "\(APIHelper.mapValueToPathItem(id))"
        let idPostEscape = idPreEscape.addingPercentEncoding(withAllowedCharacters: .urlPathAllowed) ?? ""
        localVariablePath = localVariablePath.replacingOccurrences(of: "{id}", with: idPostEscape, options: .literal, range: nil)
