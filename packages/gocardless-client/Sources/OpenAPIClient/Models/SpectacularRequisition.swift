...
public struct SpectacularRequisition: Sendable, Codable, Hashable {
    ...
    public init(id: UUID? = nil, created: Date? = nil, redirect: String?, status: StatusEnum? = nil, institutionId: String, agreement: UUID? = nil, reference: String? = nil, accounts: [JSONValue]? = nil, userLanguage: String? = nil, link: String? = "https://ob.gocardless.com/psd2/start/3fa85f64-5717-4562-b3fc-2c963f66afa6/SANDBOXFINANCE_SFIN0000", ssn: String? = nil, accountSelection: Bool? = false, redirectImmediate: Bool? = false) {
        self.id = id
...
extension SpectacularRequisition: Identifiable {}
