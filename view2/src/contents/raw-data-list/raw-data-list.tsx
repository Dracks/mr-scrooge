...
export const RawDataList : React.FC = ()=>{
    ...
    if (filters.movement){
        ...
        filteredResults = filteredResults.filter(({movementName})=>movementName.toLowerCase().indexOf(movCheck)>=0)
    }
            ...
            <TableRow>
              ...
              <TableCell scope="col" border="bottom">
                ...
                <TextInput
                    ...
                    onChange={event => setFilters({...filters, movement: event.target.value})}
                    />
              </TableCell>
              <TableCell scope="col" border="bottom">
                import
